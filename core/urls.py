...
<<<<<<< HEAD
    ...
    path('waiting-queue/<int:doctor_id>/',
         views.waiting_queue, name='waiting-queue-doctor'),
    path('doctor-queue/<int:doctor_id>/',
         views.doctor_queue, name='doctor-queue'),
    path('start-consult/<int:token_id>/',
         views.start_consultation, name='start-consult'),
    path('complete-consult/<int:token_id>/',
         views.complete_consultation, name='complete-consult'),
    path('next-patient/<int:doctor_id>/',
         views.next_patient, name='next-patient'),
]
=======
